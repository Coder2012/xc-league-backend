...
exports.scrapeLeagueTable = async (req, res, next) => {
  const scraper = new Scraper(["https://xcleague.com/xc/leagues/view-1.html"]);
  const results = await scraper.getLeagueTable();
  res.status(200).send({ flightData: results });
};
